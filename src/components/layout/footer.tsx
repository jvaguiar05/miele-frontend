  ...
  return (
    <footer className="border-t border-border/40 bg-background/50 backdrop-blur-sm">
      <div className="container px-4">
        <div className="flex flex-col sm:flex-row h-auto sm:h-12 items-center justify-between py-4 sm:py-0 gap-4 sm:gap-0">
            ...
            {footerLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.label}
                  to={link.href}
                  className="group flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-all duration-200"
                >
